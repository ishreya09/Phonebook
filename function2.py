...
def createContact():
    r= object("Create Contact", "1100x600",(1100,600),"#CED9F7")
    Title= Label(r,
    text="Create Contact", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
    ...
    def add2ndnum():
        ...
        bg="#9ccefa",
        fg="black",).pack(side=TOP,anchor=N,fill=X,padx=200)
...
def editContact(i,t,t1):
    r= object("Edit Contact", "1100x600",(1100,600),"#CED9F7")
    Title= Label(r,
    text="Edit Contact", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
    ).pack(side=TOP,fill=X)
    i[1]=str(i[1])
    i[2]=str(i[2])
    i[3]=str(i[3])
...
def delete(r1,r,i):
        #i=phonebook.index(i)
        r2=object( "{} Contact Deleted".format(i[0]), "300x100",(300,100),"#CED9F7")
        r2.maxsize(300,100)
        i[1]=str(i[1])
        i[2]=str(i[2])
        i[3]=str(i[3])
        ...
        Label(r2,text="Contact Deleted",padx=10,pady=10,bg="#c3e8e2",
        font=("Times New Roman",15),
        fg="black",relief=GROOVE).pack(side=TOP,anchor=CENTER,fill=X)
...
def open(i,r):
    r1=object( "{} Contact Info".format(i[0]), "500x500",(500,500),"#CED9F7")
    Title= Label(r1,
    text="Contact Details", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
        ).pack(side=TOP,fill=X)
...
def openList(l):
    r=object("Contacts","1100x600",(1100,600),"#CED9F7")

    Title= Label(r,
    text="Contacts", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
    ).pack(side=TOP,fill=X)
...
def dummyData():
    ...
    phonebook.append(["Skanda Prasad","9193402399","9991234733","9870912210","skanda@gmail.com","04/02/2005","friend","Bangalore Karnataka","student",str(datetime.datetime.now())])
    ...
    mb.showinfo("Data added", "Sample Data Entries added to the phone directory.")

def searchContact():
    global phonebook
    
    r= object("Search Contact", "600x600",(600,600),"#CED9F7")
    Title= Label(r,
    text="Search Contact", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
    ).pack(side=TOP,fill=X)
...
def manageGroups():
    r=object("Groups","600x600",(600,600),"#CED9F7")
    Title= Label(r,
    text="Groups", relief=GROOVE,bg="#CBF7F3",fg="black",font=("Times New Roman",30,"bold"),borderwidth=10
    ).pack(side=TOP,fill=X)
    def exist():
...
import main
def dark_mode():
    function.setPhonebook(phonebook)
    main.call()
